...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wxa49108043aac60ff'),         // AppID
    'secret'  => env('WECHAT_SECRET', '1cc2cfa814432b05858858aef4f19176'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'weixin'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', '79wLPWz9SJVwYrDvMVFcB9GCXDR6hHRMlCTRjqumCRK'),                    // EncodingAESKey
